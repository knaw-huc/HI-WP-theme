  ...
  <div class="page-intro">
    ...
    <div class="page-intro__carousel page-intro__carousel--desktop owl-carousel">
      ...
      <div class="page-intro__carousel__item">
        ...
        <a href="#" class="card card--default card--thumbnail">
          ...
          <div class="card__info">
            ...
            <div class="card__info__section">
              <h6>Tussen macht en markt</h6>
            </div>
            <!-- end .card__info__section -->

            <div class="card__info__section">
              <p>Een geschiedenis van het Nederlandse handelsrepublicanisme, 1600-1800</p>
            </div>
            <!-- end .card__info__section -->
            ...
            <div class="card__info__section">
              ...
              <div class="tag-list">
                <div class="tag-list__item">Geschiedenis</div>
                <div class="tag-list__item">Letterkunde</div>
              </div>
              <!-- end .tag-list -->
    ...
    <div class="project-filter">
      ...
      <div class="project-filter__select-holder">
        ...
        <div class="select-wrapper">
          ...
          <select class="retailer_categories">
    ...
    <div class="project-overview">
      ...
      <?php if ( have_posts() ) : ?>
        <?php while ( have_posts() ) : the_post(); ?>
          ...
          <?php include('inc/project-card.php'); ?>
