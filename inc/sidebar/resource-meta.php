...
<?php if ($types || $periods || $posttags) { ?>
  ...
  <div class="sidebar__item">
    ...
    <h4 class="sidebar__item__heading"><?php _e('Kenmerken', 'huygens'); ?></h4>
    ...
    <div class="sidebar__item__body">
      ...
      <div class="sidebar__item__text-holder sidebar__item__text-holder--filter-links">
        ...
        <?php if ($types) { ?>
          ...
          <p>
            <span><?php _e('Type', 'huygens'); ?></span><br />
        ...
        <?php if ($periods) { ?>
          ...
          <p>
            <span><?php _e('Periode', 'huygens'); ?></span><br />
        ...
        <?php if ($posttags) { ?>
          ...
          <p>
            <span><?php _e('Onderwerp', 'huygens'); ?></span><br />
